            ...
            <Card className="border-primary/20 bg-card/60 backdrop-blur-sm min-h-[500px] flex flex-col">
              ...
              <CardContent className="flex-1 flex flex-col items-center justify-center relative p-8">
                  ...
                  <div className="text-center z-10">
                     {completed ? (
                       ...
                       <div className="opacity-50">
                         {activeTab === "facial" && <Camera className="w-24 h-24 mx-auto mb-4" />}
                ...
                <div className="w-full max-w-xs space-y-4">
                  ...
                  {!scanning && !completed && (
                    <Button onClick={handleScan} size="lg" className="w-full bg-primary text-background font-bold hover:bg-primary/90 shadow-[0_0_20px_rgba(0,240,255,0.3)]">
