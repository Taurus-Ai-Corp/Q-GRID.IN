    ...
    <Layout>
      <div className="space-y-6 max-w-6xl mx-auto">
        <div className="flex justify-between items-end">
          <div>
            <h1 className="text-3xl font-heading font-bold mb-2 text-primary">Grid Pay Infra • Unlimited Offline Payment on state channel <span className="text-sm text-muted-foreground font-mono">[patent pending]</span></h1>
            <p className="text-muted-foreground">Flexible micropayment infrastructure with state channel transactions and PostgreSQL backend.</p>
          </div>
